...
if __name__ == "__main__":
    ...
    def data_loading():
        ...
        candles = pd.read_csv('./crypto-v2/binance_DOGE.csv', 
                              sep=',', 
                              low_memory=False,
                              index_col=[0])
        return candles
    ...
    if not(args.as_test):
        ...
        if args.no_tune:
            ...
            results = tune.run(
                ...
                local_dir="./crypto-v2/ray_results",
            )
        ...
        analysis = Analysis("./crypto-v2/ray_results/DQN")
        checkpoint_path = analysis.get_best_checkpoint(
            trial="./crypto-v2/ray_results/DQN/DQN_TradingEnv_a4fd9_00000_0_2021-08-18_09-57-06",
...
#python crypto_v2/core_v2.py --run DQN --symbol "DOGE/USDT" --num-cpus 4 --framework torch --stop-reward 4.0e+7 --stop-iters 500
#python crypto_v2/core_v2.py --run DQN --symbol "DOGE/USDT" --num-cpus 4 --framework torch --local-mode --as-test