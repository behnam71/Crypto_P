...
def main():
    ...
    scrape_candles_to_csv('binance_BTC.csv', 'binance', 3, 'BTC/USDT', '15m', '2017-01-01T00:00:00Z', 100)
    print("\nDOGE data fetching:")
    scrape_candles_to_csv('binance_DOGE.csv', 'binance', 3, 'DOGE/USDT', '15m', '2017-08-01T00:00:00Z', 100)
